# Features/SharedUI/bottom_bar.py
...
class BottomBar(QWidget):
    ...
    def initUI(self):
        ...
        str_how_to_use_html = '<a href="https://docs.google.com/document/d/13ckMc8KbkGt6T9giIYvtM7x5aSBHUNil0dmfvk-EyVc/edit?tab=t.0" style="color: rgb(100, 200, 255); text-decoration: none;">Tutorial URL</a>'
        ...
        str_html_text = 'Copy Left @ Made by PynkP'
