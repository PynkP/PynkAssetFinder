# Features/AssetBrowse/thumbnail_widget.py
...
class ThumbnailWidget(QFrame):
    ...
    def updateSize(self, int_w, int_h):
        ...
        self.wgt_lbl_img.setFixedSize(int_w - 4, int_h - 64)  # ✅ border 2px 좌우 합산 4px 보정
    ...
    def mousePressEvent(self, _event):
        ...
        if _event.button() == Qt.LeftButton:
            self.sig_clicked.emit(self.str_file_path, self.str_id)
